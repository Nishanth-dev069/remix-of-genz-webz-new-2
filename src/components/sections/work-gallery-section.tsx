    ...
    <section className="py-12 bg-black text-white relative">
        <div className="max-w-7xl mx-auto px-6">
            <div className="text-center space-y-6 mb-16">
                  ...
                  >
                    <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-purple-400 px-6 py-2 rounded-full border border-purple-500/20 bg-purple-500/5">Our Portfolio</span>
                  </motion.div>
                  <motion.h2 
                  ...
                  >
                    CRAFTED BY <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-purple-500">ZYXEN.</span>
                  </motion.h2>
