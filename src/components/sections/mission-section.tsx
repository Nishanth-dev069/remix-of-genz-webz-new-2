      ...
      >
        ...
        <div className="relative z-10 p-10 md:p-16 text-center space-y-10">
          <div className="space-y-4">
            <span className="inline-block text-white/40 text-[10px] font-bold uppercase tracking-[0.4em] px-6 py-2 rounded-full border border-white/10 bg-white/5">
              Our Visionary Core
            </span>
          </div>
          
          <h2 className="text-4xl md:text-7xl font-bold text-white leading-[1] tracking-tighter max-w-5xl mx-auto">
            Architecting <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white/60 italic">digital legacies.</span>
          </h2>
          
          <div className="w-12 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent mx-auto opacity-30" />
